Pod::Spec.new do |s|
  ...
  s.screenshots  = "https://raw.githubusercontent.com/kubatru/JTImageButton/master/Screens/img_example.png"

  s.license      = { :type => "MIT", :file => "LICENSE.md" }
  s.author    = "Jakub Truhlar"
  s.social_media_url   = "http://kubatruhlar.cz"
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/kubatru/JTImageButton.git", :tag => "1.0.2" }
